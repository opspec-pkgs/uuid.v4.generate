[![Build Status](https://github.com/opspec-pkgs/uuid.v4.generate/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/uuid.v4.generate/actions?query=workflow%3Abuild+branch%3Amain)
